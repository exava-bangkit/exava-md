...
@Composable
fun TourismListComposable(
    items: List<Tourism>,
    mCategory: Category?,
    onBackPressed: () -> Unit,
    onCardClick: (Tourism) -> Unit,
) {
    TourismListComposableStateless(
        items = items,
        mCategory = mCategory,
...
@Composable
private fun TourismListComposableStateless(
    items: List<Tourism>,
    mCategory: Category?,
    onBackPressed: () -> Unit,
    onCardClick: (Tourism) -> Unit
...
@Composable
private fun TourismListPreview() {
    TourismListComposable(items = listOf(),
